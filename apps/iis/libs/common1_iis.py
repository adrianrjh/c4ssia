...
ipGlobal = '192.168.100.127'
ipRedis = '192.168.100.127'
...
comboboxHorarios = ['9am-11am', '11am-13pm', '13pm-15pm', '15pm-17pm', '17pm-18pm']
comboboxPaquetePlan = ['Comodato', 'Comprado']
comboboxAnchoBanda = ['30MB', '50MB', '100MB', '200MB']
comboboxFormaPago = ['Efectivo', 'Transferencia Electronica']
...
def createNewTicket(r, key_count, id_ticket, name_client, lastname_client, dt_string, phone_client, email_client, address_client, colonia_client, localidad_client, municipio_client, estado_client, refaddress_client, location_client, datepicker_client, tiposervicio, paqueteplan, anchoBanda, formatoPago, precio_client, precioMensual, identificacion, comprobante, factura):
    try:
        ...
        r.set("tickets_iis_key",str(key_count))
        r.hmset('tickets_iis'+str(key_count), device)
    except Exception as e:
        print(e)