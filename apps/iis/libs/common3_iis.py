...
res1, res2, res3, res4, res5, res6, res7, res8 = 1, 1, 1, 1, 1, 1, 1, 1
...
columnsAsigIIS2 = [
    ui.table_column(name='text1', label='N° Serie', sortable=True, searchable=False, min_width='100'),
    ui.table_column(name='text2', label='Marca', sortable=True, searchable=False, min_width='100'),
    ui.table_column(name='text3', label='Modelo', sortable=True, searchable=False, min_width='100'),
    ui.table_column(name='text4', label='Descripcion', sortable=True, searchable=False, min_width='700'),
]
        ...
        for x in range(0, int(obj)+1):
            ...
            if obj != {}:
                if noticket == obj['id_ticket']:
                    if paso == 'paso5':
                        res = r.hset("tickets_iis"+str(x),"status", str('In Transit'))
                    if paso == 'paso6':
                        res = r.hset("tickets_iis"+str(x),"status", str('In Process'))
                    if paso == 'paso7':
                        res = r.hset("tickets_iis"+str(x),"status", str('Installation Finished'))
                    if paso == 'evidencia1':
                        res = r.hset("tickets_iis"+str(x),"evidencia1", str(data))
                    if paso == 'evidencia2':
                        res = r.hset("tickets_iis"+str(x),"evidencia2", str(data))
                    if paso == 'evidencia3':
                        res = r.hset("tickets_iis"+str(x),"evidencia3", str(data))
                    if paso == 'evidencia4':
                        res = r.hset("tickets_iis"+str(x),"evidencia4", str(data))
                    if paso == 'evidencia5':
                        res = r.hset("tickets_iis"+str(x),"evidencia5", str(data))
                    if paso == 'evidencia6':
                        res = r.hset("tickets_iis"+str(x),"evidencia6", str(data))
                    if paso == 'evidencia7':
                        res = r.hset("tickets_iis"+str(x),"evidencia7", str(data))
                    if paso == 'evidencia8':
                        res = r.hset("tickets_iis"+str(x),"evidencia8", str(data))
                    if paso == 'evidencia9':
                        res = r.hset("tickets_iis"+str(x),"evidencia9", str(data))
                return res
