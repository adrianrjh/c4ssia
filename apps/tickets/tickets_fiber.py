        ...
        while True:
            try:
                ...
                if message:
                    ...
                    if (message['channel'].decode("utf-8")=="tickets_fiber"):
                ...
                while True:
                    ...
                    try:
                        ...
                        self.pubsub.subscribe(['last_session'],['tickets_fiber'])
                        break
            time.sleep(0.001)  # be nice to the system :)

client = Listener1(r, ['last_session','tickets_fiber'])
client.start()
...
async def tickets_fiber(q: Q):
    print(str("starting tickets_fiber app..."))
...
#########   U   P   D   A   T   E     T   A   B   L   E   ############
    if q.args.btnUpd:
        data_rows = getAllTickets(r, 'tickets_key', 'tickets_', 'optical fiber')
...
@app('/tickets_fiber', mode = 'unicast')
async def team1(q: Q):
    route = q.args['#']
    await tickets_fiber(q)