...
#     ui.table_column(name='text6', label='Status', sortable=True, min_width='80', cell_type=ui.progress_table_cell_type()),
#     ui.table_column(name='text7', label='ID Caja', sortable=True, searchable=True, min_width='80'),
#     ui.table_column(name='text7', label='N° Ports', sortable=True, searchable=True, min_width='80'),
#     ui.table_column(name='text8', label='ID CE', sortable=True, searchable=True, min_width='80'),
#     ui.table_column(name='text9', label='Clients', sortable=True, searchable=True, min_width='80'),
#     ui.table_column(name='text10', label='To', sortable=True, searchable=True, min_width='80'),
#     ui.table_column(name='text11', label='Pot Calculo', sortable=True, searchable=True, min_width='80'),
#     ui.table_column(name='text12', label='Pot Real', sortable=True, searchable=True, min_width='80'),
...
#         tags=[        
#             ui.tag(label='Excelente', color='#269c14'),
#             ui.tag(label='Muy bueno', color='#b8bdb7'), 
#             ui.tag(label='Bueno', color='#d4c753'), 
#             ui.tag(label='Regular', color='#ed6d66'), 
#             ui.tag(label='Malo', color='#5db4d4'),
#             ui.tag(label='No Aplica', color='#5db4d4'),
#         ]
#     ))
# ]
