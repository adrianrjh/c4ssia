...
data_rows, data_rows_keycount = [], 0
# data_rows_density = []
proyecto = ''
...
paso1P, paso2P, paso3P, bandPaso1, bandPaso2, bandPaso3 = 1, 0, 0, 0, 0, 0, 
...
# potclient_density, idclient_density, nameclient_density, paquete_density, tecnico_density, fechainstalacion_density, noserieonu_density = '', '', '', '', '', '', ''
...
#     ui.table_column(name='text7', label='Port', sortable=True, searchable=True, min_width='80'),
#     ui.table_column(name='text8', label='Pot Calculo', sortable=True, searchable=True, min_width='80'),
#     ui.table_column(name='text9', label='Pot Real', sortable=True, searchable=True, min_width='80'),
#     ui.table_column(name='text10', label='Pot Client', sortable=True, searchable=True, min_width='80'),
#     ui.table_column(name='text11', label='ID Client', sortable=True, searchable=True, min_width='90'),
#     ui.table_column(name='text12', label='Client', sortable=True, searchable=True, min_width='90'),
#     ui.table_column(name='text13', label='Paquete', sortable=True, searchable=True, min_width='90'),
#     ui.table_column(name='text14', label='Tecnico', sortable=True, searchable=True, min_width='90'),
#     ui.table_column(name='text15', label='Fecha Instalación', sortable=True, searchable=True, min_width='90'),
#     ui.table_column(name='text16', label='N° Serie', sortable=True, searchable=True, min_width='90'),
# ]
